...
# Heroi: herda do personagem, controlado pelo usuario
...
class Personagem:
    ...
    def atacar(self, alvo):
        ...
        print(f"{self.get_nome()} atacado {alvo.get_nome()} e causou {dano} de dano!")
...
class Heroi(Personagem):
    ...
    def exibir_detalher(self):
        return f"{super().exibir_detalher()}\nHabilidade: {self.get_habilidade()}\n"
...
class Jogo:
    ...
    def iniciar_batalha(self):
        ...
        while self.heroi.get_vida() > 0 and self.inimigo.get_vida() > 0:
            ...
            print(self.heroi.exibir_detalher())
            print(self.inimigo.exibir_detalher())
            ...
            if escolha == '1':
               ...
               self.heroi.ataque_especial(self.inimigo)
                ...
                print('Escolha invalidade, escolha novamente.')
...
# Criar instancia do jogo e inicar batalha
jogo = Jogo()
